...
The code can be easily modified to adjust any optimization hyper-parameter. In addition, you can set some of these hyper-parameters directly in the terminal: --epochs, --batch_size, --lr (learning rate) and --wd (weight decay). By default, Adam optimizer is used.
